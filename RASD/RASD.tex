	...
	\section{Introduction}
		...
		\subsection{Goals}
			...
			\begin{itemize}
				...
				\item \textbf{G6} Cars returned with less then 20\% of power charged are recharged within 1 day. % to keep car used (probably need a maintenance guy)
		...
		\subsection{Domain properties}
			...
			\begin{itemize}
				...
				\item All the GPS systems always give the right position.
				\item The GPS system cannot be switched off.
				\item All cars has sensors to detect the presence of passengers in every seat.
				\item All cars are equipped with a Bluetooth system.
				\item The Bluetooth system is always on.
				\item % TODO other sensors and FIXME on added sensors
				\item The user can always provide his location, either by GPS or by giving their position themselves.
				...
				\item The cars always ignite when they have more than 3\% of power charge. % was: The cars always ignite when they are charged % FIXME Again, too much? We're assuming the cars never break... - Poe: I'd remove that
				\item The cars cannot be reserved by more than one user at any given time. %FIXME move to requirements
				\item The system is always able to tell how many people occupy a car. % FIXME move to sensor part
				% Poe's part
