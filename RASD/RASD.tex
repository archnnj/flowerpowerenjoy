	...
	\section{Introduction}
		...
		\subsection{Assumptions}
			...
			\begin{itemize}
				...
				\item The system is completely autonomous and can manage emergencies (such as the car breaking down, or street accidents) without the need of an administrator. %FIXIT we actually didn't talk about that..
				
				\item User is able to reserve available car from his geographical region. %It wasn't clear from the assignments document whether the user would be able to reserve a specific car; we assume so. %FIXIT actually depends on how Pat decides to formulate her part of the goals
