	...
	\section{Introduction}
		...
		\subsection{Goals}
			...
			\begin{itemize}
				...
				%% Poe's part %%
				\item \textbf{G1} The system applies a 20\% discount on the standard price for the current ride if the car is returned by the user with less than 50\% of power charge.
