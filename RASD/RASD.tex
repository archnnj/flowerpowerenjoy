	...
	\section{Introduction}
		...
		\subsection{Domain properties}
			...
			\begin{itemize}
				...
				\item When a user reserves a car, they always use it. %TODO move to requirements 
				...
				\item The cars cannot be reserved by more than one user at any given time. %TODO move to requirements
