...
\begin{itemize}
				...
				\item [G5] Use of a car %The system should allow the user to employ a car in a proper and safe way. 
					\begin{itemize}
				...
				\item [G6] Charges %The system charges the user for a predefined amount of money per minute. A screen on the car notifies the user of the current charges.
					\begin{itemize}
					...
					\end{itemize}
				\item [G7] Boundaries of charges %The system starts charging the user as soon as the car ignites. It stops charging them when the car is parked in a safe area and the user exits the car. The user must confirm the operation, otherwise the system keeps charging them. 
					\begin{itemize}
					...
					\end{itemize}
				\item [G8] Discounts and sanctions %The system should encourage good user behaviour and discourage bad behaviour through the application of discounts and sanctions to the fee per minute. 
					\begin{itemize}
						...
						\item The system must be able to apply a discount every time the user plugs the car in the power grid when they're finished using the car. %FIXME: 10 minutes window here?
