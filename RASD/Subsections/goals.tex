% this should be adjusted and numbered as soon as everybody has made them
			\begin{itemize}
				...
				\item \textbf{G22} In \textit{money saving option}, the system applies a certain discount for the current ride if the car is returned in the suggested safe area. % FIXME "certain" is ok?
				\item \textbf{G23} Cars returned with less then 20\% of power charge are recharged within 1 day. % to keep car used (probably need a maintenance guy)
