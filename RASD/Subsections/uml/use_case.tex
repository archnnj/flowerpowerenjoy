\subsection{Use case diagram}
	...
	\subsubsection{Use case 5: Retrieving a car with user input}
		\begin{description}
			...
			\begin{itemize}
				...
				\item \textbf{Not safely parked} The car is not safely parked.
				\item \textbf{Car impossible to reach} The operator cannot reach the car in its location.
			\end{itemize}
			\item[Special Requirements] None.
		\end{description}
