...
%TODO CHECK ALL SINGULAR IMAGES APPARENTLY THEY DIDN'T UPDATE SOMEHOW.
	...
	\subsubsection{Component view}
		...
		\paragraph{} %TODO how to write it so that it doesn't look like the cars are actors of our system?
		...
		\paragraph{Money Saving Option Manager}
			\begin{figure}[h]
	...
	%do we need to say something else?
		...
		\begin{figure}[h]
			...
			%TODO add the reservation --> user and reservation --> car dependencies